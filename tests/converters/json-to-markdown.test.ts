...
describe("JsonToMarkdownConverter", () => {
  ...
  describe("User Story Conversion", () => {
    it("should convert user story JSON to markdown", async () => {
      const userStoryJson = {
        id: "US-001",
  ...
  describe("Acceptance Criteria Conversion", () => {
    it("should convert acceptance criteria JSON to markdown", async () => {
  ...
  describe("Functional Requirements Conversion", () => {
    it("should convert functional requirements JSON to markdown", async () => {
